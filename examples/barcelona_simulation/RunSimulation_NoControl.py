...
CONTROL_MODE = "NO_CONTROL" # NO_CONTROL, DOWN_ALINEA, UP_ALINEA, DOWN_EQ_ALINEA, UP_EQ_ALINEA
...
fW.write("time"+SEPARATOR+"veh_id"+SEPARATOR+"pos_x"+SEPARATOR+"pos_y"+SEPARATOR+"angle")
fW.write("\n")
