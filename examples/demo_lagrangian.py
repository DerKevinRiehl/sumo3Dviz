"""sumo3Dviz: A three-dimensional traffic visualisation (Lagrangian demo)
...
This example demonstrates how to render a short Lagrangian-mode video
following the perspective of a single "ego" vehicle. It uses the same
configuration structure as the CLI pipeline.
...
def main(config_override=None, output_file_override=None):
    """Main function to run the Lagrangian demo. CI-only parameters: config_override, output_file_override."""
    ...
    validate_configuration(configuration, mode="lagrangian")
    # endregion
    ...
    (
        ...
        ego_identifier=configuration["modes"]["lagrangian"]["ego_identifier"],
        simtime_start=configuration["modes"]["lagrangian"]["simtime_start"],
        simtime_end=configuration["modes"]["lagrangian"]["simtime_end"],
        video_fps=configuration["rendering"]["video_fps"],
        show_other_vehicles=configuration["visualization"]["show_other_vehicles"],
    )
    ego_trajectory["veh_id"] = configuration["modes"]["lagrangian"]["ego_identifier"]
