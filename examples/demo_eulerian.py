...
def main(config_override=None, output_file_override=None):
    """Main function to run the Eulerian demo. CI-only parameters: config_override, output_file_override."""
    ...
    # in eulerian mode, this vertical distance is not noticeable from camera perspective.
