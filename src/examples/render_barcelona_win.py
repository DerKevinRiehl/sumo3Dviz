...
if __name__ == "__main__":
    ...
    sumo_network_file = os.path.abspath(
        os.path.normpath(
            os.path.join(
                os.path.realpath(__file__),
    ...
    tree_positions_file = os.path.abspath(
        os.path.normpath(
            os.path.join(
                os.path.realpath(__file__),
    ...
    viewer_height = 1.5
    traffic_signal_states_file = os.path.abspath(
        os.path.normpath(
            os.path.join(
                os.path.realpath(__file__),
    ...
    fence_lines_file = os.path.abspath(
        os.path.normpath(
            os.path.join(
                os.path.realpath(__file__),
    ...
    shops_positions_file = os.path.abspath(
        os.path.normpath(
            os.path.join(
                os.path.realpath(__file__),
    ...
    homes_positions_file = os.path.abspath(
        os.path.normpath(
            os.path.join(
                os.path.realpath(__file__),
    ...
    blocks_positions_file = os.path.abspath(
        os.path.normpath(
            os.path.join(
                os.path.realpath(__file__),
